...
for i in range(1, 2):
    ...
    bands_layer = QgsProject.instance().mapLayersByName(f'test_shoreline_grid_{i}_Bands')
    ...
    processing.run("gdal:rasterize", {
        ...
        'OUTPUT': f'C:/Users/Andrey Fritz/Downloads/dataset_creation/shoreline_grids/deploy_test/masks/test_shoreline_mask_{i}.tif'
    })
    
    print(f'Done: test_shoreline_mask_{i}.tif')