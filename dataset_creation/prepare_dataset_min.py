...
Usage:
    python prepare_dataset_min.py
    python prepare_dataset_min.py --workers 6
    python prepare_dataset_min.py --workers 6 --num_images 110
...
BASE_DIR    = "dataset"
IMAGES_ROOT = "shoreline_grids/mindanao/images"
MASKS_ROOT  = "shoreline_grids/mindanao/masks"
...
def main(num_images=110, num_workers=None):
    ...
    for i in range(num_images):
        img_path  = os.path.join(IMAGES_ROOT, f"min_shoreline_grid_{i+1}_Bands.tif")
        mask_path = os.path.join(MASKS_ROOT,  f"min_shoreline_mask_{i+1}.tif")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_images", "-n", type=int, default=110,
        help="Number of images to process (default: 110)"
    )
