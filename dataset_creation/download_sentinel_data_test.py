...
nextGridID = 1
coordinates = [
    [120.09632653880374, 26.668571226110643, 120.48992868866462, 27.037020669900055],
    [119.73499682402512, 25.217388652462457, 120.12298224615594, 25.586391617093714]
]
...
for i in range(len(coordinates)):
    ...
    REGION_NAME      = f'test_shoreline_grid_{nextGridID}'
    nextGridID      += 1
    ...
    task = ee.batch.Export.image.toDrive(
        ...
        folder         ='GEE_Thesis_Test',         # Folder name in your Google Drive
