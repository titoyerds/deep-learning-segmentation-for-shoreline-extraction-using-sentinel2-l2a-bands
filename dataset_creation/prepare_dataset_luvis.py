...
Usage:
    python prepare_dataset_luvis.py
    python prepare_dataset_luvis.py --workers 6
    python prepare_dataset_luvis.py --workers 6 --num_images 216
"""
...
BASE_DIR    = "dataset"
IMAGES_ROOT = "shoreline_grids/luzon_visayas/images"
MASKS_ROOT  = "shoreline_grids/luzon_visayas/masks"
...
def main(num_images=216, num_workers=None):
    ...
    for i in range(num_images):
        img_path  = os.path.join(IMAGES_ROOT, f"luvis_shoreline_grid_{i+1}_Bands.tif")
        mask_path = os.path.join(MASKS_ROOT,  f"luvis_shoreline_mask_{i+1}.tif")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--num_images", "-n", type=int, default=216,
        help="Number of images to process (default: 216)"
    )
