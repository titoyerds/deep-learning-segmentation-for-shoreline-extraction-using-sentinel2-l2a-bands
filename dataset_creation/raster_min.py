...
for i in range(80, 81):
    ...
    bands_layer = QgsProject.instance().mapLayersByName(f'min_shoreline_grid_{i}_Bands')
    ...
    processing.run("gdal:rasterize", {
        ...
        'OUTPUT': f'C:/Users/Andrey Fritz/Downloads/dataset_creation/shoreline_grids/mindanao/masks/min_shoreline_mask_{i}.tif'
    })
    
    print(f'Done: min_shoreline_mask_{i}.tif')